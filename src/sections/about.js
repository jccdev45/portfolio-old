...
function About({ darkMode }) {
  ...
  return (
    <section
      className="flex flex-col items-center w-full p-6 mt-2 rounded md:items-stretch md:p-8"
      style={
        darkMode.value
    ...
    >
      <div className="flex flex-col items-end w-full font-medium md:px-20 lg:px-40">
      ...
      <div className="flex flex-col items-start w-full md:items-center lg:flex-row">
        <blockquote className="leading-loose text-justify border-b-4 border-red-400 lg:w-2/3 md:mr-8 md:pl-4 md:border-l-4">
